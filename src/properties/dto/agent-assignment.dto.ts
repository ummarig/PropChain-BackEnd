...
export class AssignAgentDto {
  ...
  @ApiPropertyOptional({ description: 'The commission rate for this agent on this property (0 to 1, e.g. 0.03 for 3%)', default: 0.03 })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(1)
...
export class UpdateAgentAssignmentDto {
  @ApiPropertyOptional({ description: 'The commission rate for this agent on this property (0 to 1, e.g. 0.03 for 3%)' })
  @IsOptional()
  @IsNumber()
  @Min(0)
  @Max(1)
