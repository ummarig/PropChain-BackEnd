...
export const TRANSACTION_STATUS_ENUM = ['PENDING', 'COMPLETED', 'CANCELLED', 'FAILED'] as const;
...
export class UpdateTransactionDto {
  @IsOptional()
  @IsIn(TRANSACTION_STATUS_ENUM)
  status?: (typeof TRANSACTION_STATUS_ENUM)[number];
